...
@NgModule({
  ...
  declarations: [CreateOrganizacionComponent, ListarOrganizacionComponent, EliminarOrganizacionComponent, OrganizacionDetailComponent],
  providers: [OrganizacionService],
  exports: [CreateOrganizacionComponent, ListarOrganizacionComponent, EliminarOrganizacionComponent, OrganizacionDetailComponent]
})
